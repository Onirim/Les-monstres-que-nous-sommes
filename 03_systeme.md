...
Toutes les valeurs chiffrées d'une fiche de personnage sont exprimées en pourcentage. Pour tester une valeur, vous devez lancer 1d00. Si le résultat est égal ou inférieur à la valeur testée, alors c'est un succès, sinon c'est un échec. Il existe tout de même des résultats spéciaux lorsque les dés obtiennent un résultat particulier.
...
> Camille a décidé de plonger dans le lac, à la recherche d'un peu de silence et peut être de quelques petits objets curieux reposant dans le fond, à demi immergés dans le limon. Durant son exploration, de longues algues sombres se tendent vers elle, tentant de s'enrouler autour de ses membres et de sa bouteille d'air. La jeune fille tente de garder son sang froid et de manœuvrer pour se tirer d'affaire avant de se retrouver prise au piège. Le MJ lui demande un test d'athlétisme difficile à -10. Camille possède un score d'athlétisme de 75 et sa spécialité de plongée lui accorde un bonus de +10 supplémentaire, augmentant sa compétence à 85. La difficulté de -10 fait redescendre son score à 75. Le joueur lance les dés et obtient 58. C'est inférieur ou égal à la compétence de Camille, elle réussit donc à se tirer de ce mauvais pas, laissant derrière elle les étranges algues qui ont tenté de la noyer.

## Tests opposés

Les compétences telles que le combat, le bagou ou l’occultisme peuvent être utilisés pour se confronter à quelqu’un le temps d'une ou plusieurs actions, ce que nous appelons une opposition. Lorsque cela se produit, un test opposé est réalisé entre les protagonistes. Le vainqueur est celui qui réussi son test et, si tout le monde réussi, celui qui a fait le plus haut score sur son dé. Le perdant subit ce que dicte la fiction et doit éventuellement effectuer un test de résistance en fonction du type de test opposé. Si les deux personnages échouent ou si leur score est absolument identique, aucun n'arrive à prendre l'ascendant sur l'autre durant l'opposition.

> Au cours d'une compétition de hockey sur glace, Camille se retrouve opposée à un adversaire qui tente de la coller contre le plexiglas pour récupérer le palet. Les deux personnages doivent tester leur compétence d'athlétisme. Avec 75 d'athlétisme et une spécialité en hockey sur glace lui apportant un bonus de +10, la jeune fille est assez sûre d'elle avec un score de 85. Son adversaire est doué, il possède un score de 75. Camille roule un 43, et son adversaire un 54. Les deux personnages ayant réussi leur test, on compare le résultat des dés : le plus haut l'emporte. Dans le cas présent, l'adversaire de Camille réussit à la bloquer contre le plexiglas et à lui dérober le palet !

### Le dépassement

Lors d'un test opposé, si le score d'un protagoniste dépasse 100, la valeur de dépassement est ajoutée au résultat du dé afin de départager les protagonistes. Par exemple un personnage possédant un score d'athlétisme de 92 amélioré de +20 grâce à deux spécialités se retrouve à 112. En cas de test opposé, la valeur du dépassement de 12 permettra d'augmenter le résultat du dé et donc ses chances de réussite s'il est nécessaire de départager les adversaires.

## Test de résistance

Une résistance est testée lorsqu'un événement vient mettre en danger la santé physique ou mentale du personnage. Il existe deux types de résistances : la résistance **physique** et la résistance **mentale** ; il existe également deux gravités pour les tests de résistances : les **épreuves** et les **chocs**. Le MJ annonce la gravité et le type de résistance à tester, ensuite le joueur teste la résistance via le lancer d'1d100 et pour chaque case de stress déjà cochée dans la résistance testée, on applique un malus de -10. 

### Épreuve

Les épreuves sont des tests de résistances mineurs, qui sont peu dangereux et tendent à déstabiliser le personnage plus qu'à le mettre réellement en danger. Si le test d'épreuve est un succès, le personnage a résisté et aucun effet ne s'applique. Si le test est échoué, le personnage subit les conséquences dictées par la fiction et coche une case de stress pour la résistance concernée.

### Choc

Les chocs sont des tests de résistances majeurs, utilisés lorsqu'il y a des risques pour la santé physique ou mentale du personnage. Si le test de choc est un succès, le personnage résiste mais coche tout de même une case de stress dans la résistance concernée. Si le test est échoué, le personnage subit les conséquences dictées par la fiction et coche une case de trauma pour la résistance concernée.

> Reprenons l'exemple précédent. Si l'objectif de l'adversaire de Camille avait été de l'écraser violemment contre le plexiglas, elle aurait du réaliser en plus un test d'épreuve physique. Sans prendre en considération les protections des joueurs (nous y reviendrons dans le chapitre sur l'équipement), Camille possède un score de 60 en résistance physique. Le résultat du dé donne 86 ! C'est un échec et l'adversaire de Camille réussit donc totalement son coup : il la pousse et l'écrase violemment contre le plexiglas qui tremble sous l'impact. Camille tombe à genoux, le souffle coupé durant quelques secondes et coche une case de stress physique. Si Camille avait réussi son test d'épreuve physique, elle aurait enduré en serrant les dents, prête à rendre la monnaie de sa pièce à son adversaire.

| Gravité | Réussite | Échec |
| --- | --- | --- |
| Épreuve | aucun effet | 1 stress |
| Choc | 1 stress | 1 trauma |
...
3. **Phase de mêlée** : tous les personnages souhaitant utiliser leur action pour une attaque au corps à corps agissent à cette phase, via un test opposé. L'attaquant utilise sa compétence de combat, le défenseur peut lui aussi utiliser sa compétence de combat (dans ce cas, celui qui emporte le test opposé blesse son adversaire) ou une compétence d'athlétisme ou de filouterie pour s'esquiver (auquel cas il ne blessera pas l'attaquant s'il remporte le test opposé).
4. **Phase finale** : les personnages dont l'action n'est ni une attaque à distance ni une attaque de corps à corps agissent à cette phase. Démarrer une voiture, forcer une porte, traîner un camarade blessé sont des exemples possibles d'actions qui ont lieu à la dernière phase. Une fois que tous les personnages auront accompli leur action, on reprend à la première phase du tour suivant.

En règle générale, il n'est **pas possible de blesser plus d'un adversaire par tour**. Si un personnage est attaqué par plusieurs autres personnages à distance ou au corps à corps et réussi à gagner ses tests opposés et à rendre les coups, il devra choisir qui il blesse (et donc qui sera forcé d'effectuer un test de résistance).

Notez également que **les résultats des actions d'une phase ont toutes lieu en même temps**. Il est donc possible qu'un personnage blesse un adversaire en se faisant blesser lui-aussi. Cela n'est pas un problème car les personnages agissent par ordre de phase, et pas chacun leur tour.

En combat, l’échec d’une épreuve ou d’un choc physique peut **mettre le personnage hors de combat** si l’objectif de l’attaque était de le neutraliser. La gravité du test détermine seulement s’il subit du stress ou un trauma. Il est par exemple possible de ceinturer un adversaire et de l'immobiliser sans pour autant le blesser.
...
On ne peut pas cocher plus de 5 cases de stress. Si une 6ème case devait être cochée, une case de trauma est cochée à la place.
...
Les échecs aux chocs physiques ou mentaux se traduisent par des blessures qui peuvent durer tout un épisode voir davantage : nous les appelons les traumas. Chaque personnage possède 3 cases de trauma de chaque type (physique et mental). Un trauma est généralement subi lors de l'échec d'un test de résistance de choc. Chaque case de trauma impose un malus de **-10 aux tests de compétences**, pas aux tests de résistance. A la fin d'un épisode, un personnage peut récupérer une case de trauma physique et une case de trauma mentale, sauf si celui-ci s’achève sur un cliffhanger et que l’épisode suivant reprend sans véritable interruption.

Lorsqu'un personnage a coché ses trois cases de trauma physique ou mental, il est trop gravement blessé pour rester debout, ou mentalement brisé, et se retrouve généralement à l'hôpital. Tant qu'il n'est pas redescendu à deux cases de trauma ou moins, tout test effectué par le personnage est considéré comme échoué. On ne peut pas cocher plus de 3 cases de trauma. Si une 4ème case devait être cochée, le personnage est considéré comme mort ou bon pour l'hôpital psychiatrique.

Si un événement traumatisant devait laisser des séquelles à un personnage sur le long terme, alors il s'agit d'un élément à ajouter à ses complications.

> L'adversaire ayant envoyé Camille heurter le plexiglas aurait vraiment pu vouloir blesser la jeune fille, le MJ aurait donc pu demander un jet de choc physique qui, s'il était échoué, l'aurait envoyée au tapis avec un trauma qui lui vaudrait un malus de -10 à tous ses jets de compétences pour le reste de l'épisode. Outch ! En allant plus loin, la jeune fille aurait pu mal vivre l'échec de son équipe lors du match et le MJ aurait pu lui demander un test d'épreuve mentale. Si elle avait raté ce test, elle aurait pu également obtenir un stress mental.
...
- Les pouvoirs personnels peuvent être acquis de la même manière que les capacités, exceptés que chaque pouvoir déjà possédé compte pour 40% des chances d'acquisition.
- Les pouvoirs personnels possèdent en eux-même une valeur de 50 lorsqu'un nouveau pouvoir est acquis. Il est possible de faire progresser cette valeur de la même façon qu'une compétence.
- Les sorcières peuvent acquérir de nouveaux sortilèges de la même manière qu'une spécialité, excepté que chaque sort déjà connu compte pour 10% des chances d'acquisition.