...
Lors d'un conflit, si le score d'un protagoniste dépasse 100, la valeur de dépassement est ajoutée au résultat du dé afin de départager les protagonistes. Par exemple un personnage possédant un score d'athlétisme de 92 amélioré de +20 grâce à deux spécialités se retrouve à 112. En cas de conflit, la valeur du dépassement de 12 permettra d'augmenter le résultat du dé et donc ses chances de réussite s'il est nécessaire de départager les adversaires.
